...
export type AppointmentsControllerFindAllByCustomerV1Data = {
  endTime?: string;
  limit?: number;
  page?: number;
  startTime?: string;
...
export type AppointmentsControllerFindAllByCustomerV1Response =
  InfinityPaginationAppointmentResponseDto;

export type AppointmentsControllerFindAllByStaffV1Data = {
  limit?: number;
  page?: number;
  staffId: string;
};

export type AppointmentsControllerFindAllByStaffV1Response =
  InfinityPaginationAppointmentResponseDto;
...
export type ReceptionsControllerCheckinV1Data = {
  /**
   * ID của cuộc hẹn liên quan đến reception
   */
  appointmentId: string;
  /**
   * ID của reception cần check-in
   */
  id: string;
};
